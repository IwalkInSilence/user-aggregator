...
public class GlobalExceptionHandler {
     ...
     */
    @ExceptionHandler(AggregatorServiceException.class)
    public ResponseEntity<ErrorResponse> handleAggregateHubServiceException(AggregatorServiceException ex) {
     ...
     * @return ResponseEntity with ErrorResponse and appropriate HTTP status
     */
    @ExceptionHandler(AggregatorDatabaseFetchException.class)
    public ResponseEntity<ErrorResponse> handleAggregateHubDatabaseFetchException(AggregatorDatabaseFetchException ex) {
