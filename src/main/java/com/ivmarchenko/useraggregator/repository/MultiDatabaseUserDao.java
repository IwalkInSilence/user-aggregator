package com.ivmarchenko.useraggregator.repository;

import com.ivmarchenko.useraggregator.model.User;
import com.ivmarchenko.useraggregator.exception.AggregatorDatabaseFetchException;
        ...
        try (ExecutorService executor = Executors.newVirtualThreadPerTaskExecutor()) {
            return CompletableFuture.supplyAsync(() -> {
                ...
                if (emf == null) {
                    ...
                    throw new AggregatorDatabaseFetchException("EntityManagerFactory not found for database: " + dbName);
                }
                try (EntityManager em = emf.createEntityManager()) {
                    ...
                    throw new AggregatorDatabaseFetchException("Error fetching users from database: " + dbName, ex);
                }
            }, executor);
        }
    }
