...
import com.ivmarchenko.useraggregator.strategy.DatabaseStrategy;
...
public class MultiDatabaseConfig {
    ...
    public void init() {
        ...
        for (DatabaseConfig dbConfig : databaseListConfig.dataSources()) {
            ...
            String table = dbConfig.getTable()!= null && !dbConfig.getTable().isEmpty() ? dbConfig.getTable() : "users";

            // Create and store EntityManagerFactory
            LocalContainerEntityManagerFactoryBean emfBean = strategy.createEntityManagerFactory(
                    dataSource, dbConfig.getName() + "PU", mapping, table);
